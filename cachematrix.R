## The functions present in this file allow for caching the inverse
...
##
## This function works analogous to the example makeVector function.
...
##
## This function works analogous to the example cachemean function.
